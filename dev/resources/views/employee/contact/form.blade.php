                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" name="nt_address" id="address"
                                    {{($cType == \App\Models\BexioEmployee::CONTACT_TYPE_COMPANY ? ' ' : '')}}>{{ old('nt_address', ($chData['address'] ?? $record->address)) }}</textarea>
                                @error('nt_address')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="nt_postal_code" id="postal_code"
                                    ...
                                    {{($cType == \App\Models\BexioEmployee::CONTACT_TYPE_COMPANY ? '' : '')}} />
