    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-style settings-card-2">
                ...
                <form class="nt-form" action="{{route('employee.call.log.global-store')}}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" data-url="{{route('employee.clockodo.projects')}}" id="client"
                                    ...
                                    <option value="{{$customer['id']}}"
                                        {{$firstclockodocompany->clockodo_emp_id == $customer['id'] ?'selected':''}}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="duration" name="nt_duration" value="{{$duration}}"
                                    tabindex="2" placeholder="hh:mm" required />
                            </div>
                            <div class="mb-3">
                                <label for="endTime" class="form-label">{{__('End Time')}}</label>
                                <input type="text" class="form-control" id="endTime" name="nt_end_time" value="{{$callEndedAt}}"
                                    tabindex="4" required />
                            </div>
                            <div class="mb-3">
